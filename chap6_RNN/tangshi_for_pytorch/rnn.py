...
class RNN_model(nn.Module):
    def __init__(self, batch_sz ,vocab_len ,word_embedding,embedding_dim, lstm_hidden_dim):
        ...
        # ???
        self.rnn_lstm = nn.LSTM(embedding_dim, lstm_hidden_dim, num_layers=2, batch_first=True) #输入是embedding_dim,输出是lstm_hidden_dim，layers=2，batchfirst
    ...
    def forward(self,sentence,is_test = False):
        ...
        # ???
        h0=torch.zeros(2,1,self.lstm_dim).to(batch_input.device) #初始化隐藏层和细胞状态为0
